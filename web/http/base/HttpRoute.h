...
#ifndef WEBSERVER_HTTPROUTE_H
#define WEBSERVER_HTTPROUTE_H
...
namespace Tiny_muduo::Http
{
    class HttpRequest;
    class HttpResponse;
    typedef std::function<void(const HttpRequest& , HttpResponse*)> ContextHandler;
    ...
    public:
        ...
        std::string& getPattern() { return pattern_; }

        void handle(const HttpRequest& request, HttpResponse* response) { handler_(request, response); }
    ...
    public:
        ...
        std::tuple<bool, bool, Node*> findRoute(const HttpRequest& request, HttpResponse* response);
