...
//    std::cout << "Headers " << req.getMethodStr() << " " << req.getUrl().getPath() << std::endl;
//    if (!benchmark)
//    {
//        std::cout << req.getHeader().size() << std::endl;
...
//                      "</body></html>");
//    }
//    else if (req.getUrl().getPath()  == "/favicon.ico")
//    {
//        resp->setStatusCode(HttpResponse::k200Ok);
//        resp->setStatusMessage("OK");
//        resp->setContentType("image/png");
//        resp->setBody(std::string(favicon, sizeof favicon));
//    }
//    else if (req.getUrl().getPath()  == "/hello")
//    {
//        resp->setStatusCode(HttpResponse::k200Ok);
//        resp->setStatusMessage("OK");
//        resp->setContentType("text/plain");
...
//    {
//        benchmark = true;
//        log::Logger::setLogLevel(log::LogLevel::WARN);
